...
export const metadata: Metadata = {
  title: "What date is 120 Days From Today? - Countdown",
  description:
    "What's the date 120 days from now? Get the exact answer in seconds, plus a live countdown, calendar view, and a quick trick for doing the math yourself.",
  keywords: [
    "120 days from today",
    "120 days from now",
...
export default function OneHundredTwentyDaysFromTodayPage() {
 ...
 const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.lizocalc.com/calculators/time/120-days-from-today-calculator#breadcrumb",
      itemListElement: [
        ...
        { "@type": "ListItem", position: 4, name: "120 Days From Today Calculator", item: "https://www.lizocalc.com/calculators/time/120-days-from-today-calculator" },
      ],
    },
    {
      "@type": "WebPage",
      ...
      breadcrumb: { "@id": "https://www.lizocalc.com/calculators/time/120-days-from-today-calculator#breadcrumb" },
      ...
      <article className="max-w-6xl mx-auto px-6 py-16 text-white">
        ...
        <section className="mt-4">
          <p className="text-gray-200 leading-relaxed text-lg">
            The date 120 days from today is <strong>{fullDateStr}</strong>,
            which is 17 weeks and 1 day from now. This calculation is made
            using{" "}
            <Link
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 text-base mb-6">
            ...
            one lands on 120 days further out.
          </p>
            ...
            <table className="w-full text-left border-collapse min-w-[560px]">
              <thead>
                <tr className="bg-blue-900/70">
                  ...
                  <th className="p-4 text-sm sm:text-base font-semibold">+120 Days</th>
                </tr>
              </thead>
              <tbody className="bg-gray-800/50 divide-y divide-gray-700">
                {relativeRange.map((n) => {
                  const rowDate = addDays(today, n);
                  const plusOneTwenty = addDays(rowDate, 120);
                  const isToday = n === 0;
                  return (
                    <tr key={n} className={isToday ? "bg-blue-900/40" : ""}>
                      ...
                      <td className="p-4">{formatMedium(plusOneTwenty)}</td>
                    </tr>
                  );
                })}
              </tbody>
...
<section className="mt-20">
  ...
  <p className="text-gray-200 leading-relaxed text-base mb-4">
    To find a date 120 days from today, count forward through the calendar
    for 120 days. This includes every day of the week, so weekends and
    holidays are part of the total.
  </p>

  <p className="text-gray-200 leading-relaxed text-base mb-4">
    A period of 120 days is longer than four months in some cases, so the
    exact result should be based on the actual number of days in each month.
    It is better to count 120 days directly rather than simply adding a
    fixed number of months.
  </p>

  <p className="text-gray-200 leading-relaxed text-base">
    Starting from {formatFull(today)}, the date exactly 120 calendar days
    later is <strong>{fullDateStr}</strong>.
  </p>
</section>
        {/* ── OTHER DAY COUNTS FROM TODAY ── */}
        <section className="mt-20">
...
<section className="mt-20">
  ...
  <p className="text-gray-200 leading-relaxed text-base mb-4">
    When weekends are not included, 120 working days means counting only
    Monday through Friday. At five weekdays per week, this period covers
    24 complete workweeks.
  </p>
  ...
  <p className="text-gray-200 leading-relaxed text-base">
    If {formatFull(today)} is the starting date, counting 120 weekdays gives
    <strong> {formatFull(weekdayTarget)}</strong>. Saturdays and Sundays are
    skipped, while public holidays are not automatically removed. For a
    deadline that excludes holidays as well, use our{" "}
    <Link
        ...
        <section className="mt-20 flex justify-center">
          <div className="bg-gray-800/40 p-8 rounded-2xl border border-gray-700 max-w-xl w-full text-center">
            ...
            <ul className="text-gray-200 space-y-3 text-base list-none">
              ...
              <li>172,800 minutes</li>
              <li>10,368,000 seconds</li>
            </ul>
          </div>
        </section>
