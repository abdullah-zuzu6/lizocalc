...
export const metadata: Metadata = {
  title: "What date is 28 Days From Today? - Countdown",
  description:
    "What's the date 28 days from now? Get the exact answer in seconds, plus a live countdown, calendar view, and a quick trick for doing the math yourself.",
  keywords: [
    "28 days from today",
    "28 days from now",
  ...
  alternates: {
    canonical: "https://www.lizocalc.com/calculators/time/28-days-from-today",
  },
  ...
  openGraph: {
    ...
    url: "https://www.lizocalc.com/calculators/time/28-days-from-today",
    siteName: "LizoCalc",
    type: "website",
  },
...
export default function TwentyEightDaysFromTodayPage() {
  ...
  // day's date and what date is 28 days further out from it.
  ...
  const quickReferenceDays = [28, 30, 45, 60, 90, 120];

  const weekdayTarget = addWeekdays(today, 28);
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.lizocalc.com/calculators/time/28-days-from-today#breadcrumb",
      itemListElement: [
        ...
        { "@type": "ListItem", position: 4, name: "28 Days From Today Calculator", item: "https://www.lizocalc.com/calculators/time/28-days-from-today" },
      ],
    },
    {
      "@type": "WebPage",
      "@id": "https://www.lizocalc.com/calculators/time/28-days-from-today",
      url: "https://www.lizocalc.com/calculators/time/28-days-from-today",
      ...
      breadcrumb: { "@id": "https://www.lizocalc.com/calculators/time/28-days-from-today#breadcrumb" },
      ...
      <article className="max-w-6xl mx-auto px-6 py-16 text-white">
        ...
        <section className="mt-4">
          <p className="text-gray-200 leading-relaxed text-lg">
            The date 28 days from today is <strong>{fullDateStr}</strong>,
            which is exactly 4 weeks from now. This calculation is made
            using {" "}
            <Link
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 text-base mb-6">
            ...
            one lands on 28 days further out.
          </p>
            ...
            <table className="w-full text-left border-collapse min-w-[560px]">
              <thead>
                <tr className="bg-blue-900/70">
                  ...
                  <th className="p-4 text-sm sm:text-base font-semibold">+28 Days</th>
                </tr>
              </thead>
              <tbody className="bg-gray-800/50 divide-y divide-gray-700">
                {relativeRange.map((n) => {
                  const rowDate = addDays(today, n);
                  const plusTwentyEight = addDays(rowDate, 28);
                  const isToday = n === 0;
                  return (
                    <tr key={n} className={isToday ? "bg-blue-900/40" : ""}>
                      ...
                      <td className="p-4">{formatMedium(plusTwentyEight)}</td>
                    </tr>
                  );
                })}
              </tbody>
...
<section className="mt-20">
  ...
  <p className="text-gray-200 leading-relaxed text-base mb-4">
    Calculating a date 28 days from today is the same as moving forward
    exactly four weeks on the calendar. Because each week has seven days,
    28 days gives you a full four-week period.
  </p>

  <p className="text-gray-200 leading-relaxed text-base mb-4">
    Begin with today&apos;s date and count 28 calendar days ahead. Saturdays,
    Sundays, and holidays are included because this is a calendar-day
    calculation. If the count passes the end of the current month, continue
    into the next month until all 28 days have been counted.
  </p>

  <p className="text-gray-200 leading-relaxed text-base">
    Today is {formatFull(today)}, and 28 days after this date is
    <strong> {fullDateStr}</strong>. Since 28 days is exactly four weeks, the
    result falls on the same day of the week as today.
  </p>
</section>
       ...
       {/* ── 28 WEEKDAYS FROM TODAY ── */}

<section className="mt-20">
  <h2 className="text-3xl md:text-4xl font-bold text-blue-500 border-b border-blue-600 pb-4 mb-8">
    What Date Is 28 Weekdays From Today?
  </h2>

  <p className="text-gray-200 leading-relaxed text-base mb-4">
    A period of 28 weekdays covers four complete Monday-to-Friday weeks.
    Unlike a regular 28-day calculation, Saturdays and Sundays are not
    included in the weekday count.
  </p>

  <p className="text-gray-200 leading-relaxed text-base mb-6">
    Starting with {formatFull(today)}, and counting forward through weekdays
    only, the 28th weekday is <strong>{formatFull(weekdayTarget)}</strong>.
    Weekend dates are passed over without being added to the total.
  </p>
  ...
  <p className="text-gray-200 leading-relaxed text-base">
    This calculation treats Monday through Friday as weekdays and does not
    exclude public holidays. If you are working with a deadline where
    holidays also need to be skipped, the result may be different. In that
    case, you can use our{" "}
    <Link
    ...
    {" "}to include weekends and holidays in the calculation.
  </p>
</section>

        {/* ── 28 DAYS IN OTHER UNITS ── */}
        <section className="mt-20 flex justify-center">
          <div className="bg-gray-800/40 p-8 rounded-2xl border border-gray-700 max-w-xl w-full text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-blue-500 mb-4">
              28 Days Time in Other Units
            </h2>
            <p className="text-gray-200 leading-relaxed text-base mb-6">
              Twenty-eight days is the same amount of time as:
            </p>
            <ul className="text-gray-200 space-y-3 text-base list-none">
              ...
              <li>40,320 minutes</li>
              <li>2,419,200 seconds</li>
            </ul>
          </div>
        </section>
        ...
        <section className="px-0 mt-20 mb-4 flex justify-center">
          <SimilarCalculators
           ...
           links={[
              { label: "45 Days From Today", href: "/info/days/45-days-from-today" },
              { label: "60 Days From Today", href: "/info/days/60-days-from-today" },
              { label: "Day OF Week Calculator", href: "/calculators/time/days-of-week-calculator" },
