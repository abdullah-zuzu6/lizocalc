...
export const metadata: Metadata = {
  title: "What date is 90 Days From Today? - Countdown",
  description:
    "What's the date 90 days from now? Get the exact answer in seconds, plus a live countdown, calendar view, and a quick trick for doing the math yourself.",
  keywords: [
    "90 days from today",
    "90 days from now",
  ...
  twitter: {
    ...
    description:
      "What date is 90 days from today? Find out instantly with our free calculator.",
  },
};
...
export default function NinetyDaysFromTodayPage() {
  ...
  // day's date and what date is 90 days further out from it.
      ...
      <article className="max-w-6xl mx-auto px-6 py-16 text-white">
        ...
        <section className="mt-4">
          <p className="text-gray-200 leading-relaxed text-lg">
            The date 90 days from today is <strong>{fullDateStr}</strong>,
            which is 12 weeks and 6 days from now. This calculation is made
            using{" "}
            <Link
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 text-base mb-6">
            ...
            one lands on 90 days further out.
          </p>
            ...
            <table className="w-full text-left border-collapse min-w-[560px]">
              ...
              <tbody className="bg-gray-800/50 divide-y divide-gray-700">
                {relativeRange.map((n) => {
                  ...
                  const plusNinety = addDays(rowDate, 90);
                  const isToday = n === 0;
                  return (
                    <tr key={n} className={isToday ? "bg-blue-900/40" : ""}>
                      ...
                      <td className="p-4">{formatMedium(plusNinety)}</td>
                    </tr>
                  );
                })}
              </tbody>
...
<section className="mt-20">
  ...
  <p className="text-gray-200 leading-relaxed text-base mb-4">
    To find the date 90 days from today, count forward exactly 90 calendar
    days. All seven days of the week are included, so weekends and holidays
    remain part of the total.
  </p>

  <p className="text-gray-200 leading-relaxed text-base mb-4">
    Ninety days is often described as about three months, but the two
    periods are not always identical. Adding three calendar months can give
    a different date because each month has a different number of days.
  </p>

  <p className="text-gray-200 leading-relaxed text-base">
    Based on today&apos;s date, {formatFull(today)}, the date 90 days from
    today is <strong>{fullDateStr}</strong>.
  </p>
</section>
...
<section className="mt-20">
  ...
  <p className="text-gray-200 leading-relaxed text-base mb-4">
    Ninety working days counts weekdays only, so Saturdays and Sundays are
    left out of the calculation. With five weekdays in a normal workweek,
    90 working days make up 18 complete workweeks.
  </p>
  ...
  <p className="text-gray-200 leading-relaxed text-base">
    From {formatFull(today)}, the date reached after 90 weekdays is
    <strong> {formatFull(weekdayTarget)}</strong>. This calculation skips
    weekends but does not remove public holidays. If holidays are also
    excluded from the period, use our{" "}
    <Link
