...
// NOTE ON THE FIX BELOW: these strings use LaTeX (\frac, \Delta) inside
// normal (non-raw) JS strings. In a JS string literal, a backslash followed
// by a letter that isn't a recognized escape is usually just dropped — BUT
// "\f" specifically IS a recognized escape (form feed, an invisible control
// character). That means the original "\frac{d}{t}" silently rendered as a
// form-feed character followed by "rac{d}{t}", breaking every formula that
// used \frac. Every LaTeX backslash below is now doubled ("\\frac",
// "\\Delta") so the literal backslash reaches your KaTeX/MathJax renderer
// instead of being consumed as an escape sequence.
const faqData = [
  {
    question: "What is the basic formula for calculating speed?",
    answer:
      "Speed is defined as the distance traveled per unit of time. The standard formula used by most calculators is $v = \\frac{d}{t}$, where $v$ represents speed, $d$ is the total distance, and $t$ is the time elapsed. For example, if a car travels 150 kilometers in 3 hours, its average speed is $50 km/h$.",
  },
  {
    question: "How do you calculate speed if you have different units?",
    answer:
      "To get an accurate result, you must ensure your units are compatible. If you have distance in miles and time in minutes but want miles per hour (mph), first divide the minutes by 60 to get hours. For a 10-mile trip taking 15 minutes: $15 / 60 = 0.25$ hours. Then, $10 / 0.25 = 40 mph$. Using an online speed calculator automates these conversions for you.",
  },
  {
    question: "What is the difference between speed and velocity?",
    answer:
      "While often used interchangeably, they are different in physics. Speed is a scalar quantity (only magnitude), whereas velocity is a vector quantity (magnitude and direction). If a plane flies at $500 mph$, that is its speed; if it flies $500 mph$ Due North, that is its velocity. Both use the same base calculation: $v = \\frac{\\Delta s}{\\Delta t}$.",
  },
  {
    question:
      "How do I calculate average speed for a trip with multiple stops?",
    answer:
      "Average speed is not the average of your speeds, but the total distance divided by the total time (including stopped time). The formula is $v_{avg} = \\frac{\\text{Total Distance}}{\\text{Total Time}}$. If you drive 60 miles in 1 hour, stop for 30 minutes, and drive another 40 miles in 1 hour, your total distance is 100 miles and total time is 2.5 hours, resulting in an average speed of $40 mph$.",
  },
  {
    question: "How does a speed calculator convert km/h to m/s?",
    answer:
      "Converting from kilometers per hour ($km/h$) to meters per second ($m/s$) involves a specific conversion factor. Since $1 km = 1,000m$ and $1 hour = 3,600s$, you divide the $km/h$ value by 3.6. For example, $90 km/h$ divided by 3.6 equals $25 m/s$.",
  },
  {
    question: "What is instantaneous speed versus average speed?",
    answer:
      "Instantaneous speed is the speed of an object at a specific moment in time—this is what your car's speedometer shows. Average speed is the overall rate of motion over a duration of time. While your instantaneous speed might fluctuate between $0 mph$ and $70 mph$ during a commute, your average speed might only be $35 mph$ due to traffic lights.",
  },
];
    ...
    <main className="min-h-screen bg-background">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3">
            <h1 className="text-3xl md:text-4xl font-bold">
              Speed Calculator: Calculate Average Velocity, Pace, and Unit
      ...
      <article className="max-w-6xl mx-auto px-6 py-16 text-white">
        <p className="text-gray-200 leading-relaxed mb-6 text-lg">
          ...
          Distance-Speed-Time Calculator or Average Speed Calculator — is one
          of the most important and frequently used concepts in elementary,
          middle school, and even high school mathematics and physics.
          Whether you&apos;re a student working on your class 7 or 8 physics
          homework, a parent helping your child with road-trip problems, a
          teacher preparing examples for the blackboard, a driver calculating
          fuel-efficient speeds, or just someone who needs to quickly figure
          out travel time or distance in real life, knowing how to calculate
          speed makes many tasks faster and less frustrating.
        </p>
        ...
        <p className="text-gray-200 leading-relaxed mb-8 text-lg">
          ...
          etc.), click the calculate button, and get instant results —
          complete with a clean result display, highlighted formula
          breakdown, unit conversions, and (when you expand it) step-by-step
          explanations using the basic formula, unit conversions, or
          average-speed logic. The tool is fully mobile-friendly, works
          offline after first load (progressive web app style), remembers
          your last values (with your consent), handles large inputs,
          supports multiple segments for average speed, and never shows any
          ads. Perfect for quick homework checks, exam preparation, road
          trips, sports training, or everyday practical calculations. Jump
            ...
            <div className="bg-gray-800/50 p-7 rounded-2xl border border-gray-700 shadow-sm">
              ...
              <ol className="list-decimal list-inside text-gray-200 space-y-4 text-base leading-relaxed">
                ...
                <li>
                  ...
                  (example: <code>3</code> hours or <code>120</code>{" "}
                  minutes).
                </li>
                <li>
                  Choose what you want to calculate — Speed, Distance, or
                  Time — using the toggle or dropdown.
                </li>
                <li>
                  Press the large, eye-catching{" "}
                  <strong>Calculate Speed</strong> button.
                </li>
                <li>
                  Instantly see the result displayed in big, bold text at the
                  top of the results area (with automatic unit conversion
                  shown).
                </li>
                <li>
                  Look below for the formula breakdown — every step is
                  listed, and the final answer is highlighted clearly.
                </li>
                <li>
                  Want to see the working? Expand the detailed steps section
                  to view the full calculation with unit handling or
                  average-speed logic for multi-segment journeys.
                </li>
                <li>
                  Finished? Hit the <strong>Reset</strong> button to clear
                  everything instantly — perfect when you&apos;re working
                  through a whole worksheet or planning multiple trips.
                </li>
              </ol>
              <p className="text-gray-200 italic mt-6 text-base leading-relaxed">
                ...
                prevents crashes so you can focus on learning instead of
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 leading-relaxed mb-6 text-base">
            Speed is the{" "}
            <strong>rate at which distance is covered in a given time</strong>
            . The Speed Calculator instantly solves any one of the three
            variables using the fundamental relationship between distance,
            speed, and time.
          </p>

          <p className="text-gray-200 leading-relaxed mb-6 text-base">
            Classic school example everyone learns first: A car travels 240
            km in 4 hours. Distance = 240 km, Time = 4 h. Speed = 240 ÷ 4 ={" "}
          ...
          <p className="text-gray-200 text-base leading-relaxed mb-4">
            In school and board exams, “speed” usually means{" "}
            <strong>average speed</strong>. Velocity includes direction
            (vector), while speed is scalar (just magnitude). Our calculator
            focuses on speed and average speed — exactly what you need for
            Punjab Board, CBSE, or Matric exams.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            <div className="bg-gray-800/40 p-6 rounded-xl border border-gray-700">
              ...
              <p className="text-gray-200 text-base">
                ...
                distance (d = speed × time) and time (t = distance / speed)
                in one click.
              </p>
            </div>
            ...
            <div className="bg-gray-800/40 p-6 rounded-xl border border-gray-700">
              ...
              <p className="text-gray-200 text-base">
                Speed can be in km/h, mph, or m/s. Our calculator
                auto-converts everything so you never have to remember the
                3.6 multiplier again.
              </p>
            </div>
          </div>
          ...
          <p className="text-gray-200 text-base leading-relaxed mb-4">
            Mastering speed calculations is like having a master key — it
            opens doors to many other important topics:
          </p>
          <ul className="list-disc list-inside text-gray-200 space-y-3 text-base ml-5">
            ...
            <li>
              Real-life applications like fuel efficiency and arrival time
            </li>
        ...
        <section className="mt-20">
            ...
            <table className="min-w-full text-sm text-white border border-gray-700 rounded-xl overflow-hidden">
              ...
              <tbody className="bg-gray-800/50 divide-y divide-gray-700">
                <tr>
                  ...
                  <td className="p-4">Simple school problems</td>
                  <td className="p-4">Extremely fast</td>
                  <td className="p-4">100%</td>
                  <td className="p-4">Very easy</td>
                  <td className="p-4">Yes — default method</td>
                </tr>
                <tr>
                  <td className="p-4">Unit Conversion</td>
                  <td className="p-4">Different units (km/h ↔ m/s)</td>
                  <td className="p-4">Instant</td>
                  <td className="p-4">100%</td>
                  <td className="p-4">Easy</td>
                  <td className="p-4">Yes — automatic conversion</td>
                </tr>
                <tr>
                  <td className="p-4">Average Speed (Multi-segment)</td>
                  <td className="p-4">Journeys with stops</td>
                  <td className="p-4">Fast</td>
                  <td className="p-4">100%</td>
                  <td className="p-4">Medium</td>
                  <td className="p-4">Yes — handles multiple legs</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <p className="text-gray-200 text-base mb-4">
            Use the core formula and solve for whichever variable you need.
            This method is perfect for quick homework.
          </p>
          ...
          <p className="text-gray-200 text-base">
            60 km/h × (1000 m / 3600 s) = 60 ×{" "}
            <span className="font-mono text-green-300">5/18</span> ={" "}
          ...
          <p className="text-gray-200 text-base mb-4">
            Total distance ÷ total time (ignores different speeds per
            segment).
          </p>
          <h4 className="text-xl font-bold text-blue-300 mt-5 mb-2">
            Example: Sahiwal to Lahore (150 km in 2.5 h) + Lahore to
            Faisalabad (120 km in 2 h)
          </h4>
          <p className="text-gray-200 text-base">
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 text-base">
            ...
            results — while also handling all unit conversions automatically
            and showing you the friendly step-by-step view so you can
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 text-base">
            ...
            <strong>150 km</strong>. Perfect for fuel planning or odometer
            checks.
          </p>
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 text-base">
            Speed = 360 ÷ 5 = <strong>72 km/h</strong>. Simple board-exam
            style question.
          </p>
          ...
          <p className="text-gray-200 text-base">
            Multiply by{" "}
            <span className="font-mono text-green-300">5/18</span> or divide
            by 3.6. Our calculator does it automatically every time.
          </p>
        </section>
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 text-base mb-6">
            Pair your speed practice with these other free, fast calculators
            from our collection:
          </p>
          ...
          <p className="text-gray-200 italic text-center mt-20 text-lg font-medium leading-relaxed">
            Master speed, distance and time problems — our speed calculator
            is fast, accurate, completely free, and always ready whenever you
            need it. Bookmark it today and make your physics homework, exam
            prep, or daily travel calculations so much easier!
          </p>
        </section>
      </article>
