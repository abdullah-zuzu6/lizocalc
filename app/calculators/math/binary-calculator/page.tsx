...
export default function BinaryCalculatorPage() {
  ...
  <section>
    ...
    <div className="mt-8 space-y-10">
      <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
        ...
        <p className="text-gray-200 leading-relaxed mb-4">
          Type or paste binary strings into both input boxes. The tool strictly enforces binary rules — only digits <strong>0</strong> and <strong>1</strong> are accepted. Any invalid character (letters, 2–9, spaces, symbols) triggers an immediate clear error message.
        </p>
      ...
      <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
        ...
        <ul className="list-disc list-inside text-gray-200 space-y-2 pl-6">
          <li><strong>Addition (+)</strong> — Bit-by-bit with carry</li>
          <li><strong>Subtraction (−)</strong> — Bit-by-bit with borrow</li>
          <li><strong>Multiplication (×)</strong> — Shift-and-add style</li>
          <li><strong>Division (÷)</strong> — Integer division via repeated subtraction</li>
        </ul>
      </div>
      ...
      <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
        ...
        <ul className="list-disc list-inside text-gray-200 space-y-2 pl-6">
          <li><strong>Binary</strong> — Raw arithmetic result</li>
          <li><strong>Decimal</strong> — Easy-to-read base-10 value</li>
          <li><strong>Hexadecimal</strong> — Compact 0x format (programming favorite)</li>
        </ul>
      </div>
  ...
  <section className="mt-20">
    ...
    <p className="text-gray-200 mb-4">
      Every position in a binary number represents a power of 2. We always start counting positions from the <strong>rightmost bit</strong> (called the Least Significant Bit – LSB), which is 2⁰ = 1.
    </p>

    <p className="text-gray-200 mb-6">
      Formula:<br />
      <strong>Decimal = Σ (bit × 2^position)</strong>, where position starts at 0 from the right.
    </p>
  ...
  <table className="min-w-full text-sm md:text-base text-white border border-gray-600 border-collapse rounded-lg overflow-hidden">
    <thead>
      <tr className="bg-blue-900/60">
        <th className="p-3 md:p-4 text-left font-semibold whitespace-nowrap">Bit (from right to left)</th>
        <th className="p-3 md:p-4 text-left font-semibold whitespace-nowrap">Position</th>
        <th className="p-3 md:p-4 text-left font-semibold whitespace-nowrap">Power of 2</th>
        <th className="p-3 md:p-4 text-left font-semibold whitespace-nowrap">Calculation</th>
        <th className="p-3 md:p-4 text-left font-semibold whitespace-nowrap">Value</th>
      </tr>
    </thead>
    ...
    <ul className="list-decimal list-inside text-gray-200 space-y-1.5 pl-6 mb-6">
      <li>29 ÷ 2 = 14 rem <strong>1</strong></li>
      <li>14 ÷ 2 = 7 rem <strong>0</strong></li>
      <li>7 ÷ 2 = 3 rem <strong>1</strong></li>
      <li>3 ÷ 2 = 1 rem <strong>1</strong></li>
      <li>1 ÷ 2 = 0 rem <strong>1</strong></li>
    </ul>
...
Remainder:      0
  ...
  <section className="mt-20">
    ...
    <ul className="list-disc list-inside text-gray-200 space-y-3">
      <li><strong>Binary:</strong> Direct computation output</li>
      <li><strong>Decimal:</strong> Standard base-10 equivalent</li>
      <li><strong>Hexadecimal:</strong> 0x format (memory, colors, bitwise debugging)</li>
    </ul>
    ...
    <ul className="list-disc list-inside text-gray-200 space-y-3">
      <li><strong>Invalid Input Error:</strong> Only 0 & 1 allowed — remove other characters</li>
      <li><strong>Division by Zero:</strong> Shows clear warning — change divisor</li>
      <li><strong>Negative Results:</strong> Unsigned calculator only — for negatives use two's complement elsewhere</li>
      <li><strong>Unexpected Result?:</strong> Verify inputs/operator → reset → re-calculate</li>
    </ul>
