...
export const metadata: Metadata = {
  ...
  description:
    "calculate your daily calorie needs with our bmr and tdee tool. input your age, weight, and activity level to get personalized results for weight management.",
  keywords: [
    ...
    <main className="min-h-screen bg-background">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3">
            <h1 className="text-3xl md:text-4xl font-bold">
              Calorie calculator: find your bmr and daily energy
              expenditure{" "}
            </h1>
          </div>
        </div>
      ...
      <article className="max-w-6xl mx-auto px-6 py-16 text-white">
        <p className="text-gray-200 leading-relaxed mb-6 text-lg">
          The <strong>Calorie and TDEE Calculator</strong> — your complete daily
          calorie needs tool — is one of the most powerful and practical
          resources for fitness, weight management, and healthy living. Whether
          you're a student in juggling studies and gym goals, a busy
          professional in Lahore or Karachi trying to lose stubborn belly fat, a
          homemaker in Islamabad planning family meals, or anyone across
          Pakistan and the world who wants science-backed control over their
          body composition, this free calculator removes all the guesswork.
        </p>

        <p className="text-gray-200 leading-relaxed mb-8 text-lg">
          Our completely free, no-registration-required{" "}
          <strong>calorie calculator and TDEE calculator</strong> instantly
          computes your Basal Metabolic Rate (BMR) and Total Daily Energy
          Expenditure (TDEE) using the proven Harris-Benedict formula. Just
          enter a few details, choose your activity level, and get personalized
          calorie targets for weight loss, maintenance, or muscle gain —
          complete with real-time updates, clean results, and zero ads. The tool
          is fully mobile-friendly, works offline after first load (progressive
          web app style), automatically saves your last inputs (with your cookie
          consent), supports both metric and imperial units, and is perfect for
          quick daily tracking. Whether you're in planning your next meal or
          traveling abroad, jump right in and try it now on our{" "}
          <Link
          ...
          <div className="mt-8 space-y-10">
            <div className="bg-gray-800/50 p-7 rounded-2xl border border-gray-700 shadow-sm">
              ...
              <p className="text-gray-200 leading-relaxed text-base mb-4">
                Start by typing your age in years, current weight (in kg or
                lbs), and height (in cm or feet/inches). These three values form
                the foundation of the Harris-Benedict equation and directly
                influence your BMR. The calculator automatically converts units
                if you switch between metric and imperial — perfect for users in
                Pakistan who prefer kilograms and centimetres or those
                comfortable with pounds and inches.
              </p>
              <p className="text-gray-200 text-base italic">
                Pro tip: For the most accurate results, use your most recent
                measurements taken first thing in the morning after waking up.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 p-7 rounded-2xl border border-gray-700 shadow-sm">
              ...
              <p className="text-gray-200 leading-relaxed text-base mb-4">
                Choose male or female. The Harris-Benedict formula uses
                different constants for each gender because men typically have
                higher muscle mass and therefore burn more calories at rest.
                This single selection can change your BMR by 10–15% — a huge
                difference when setting realistic calorie goals.
              </p>
            </div>

            <div className="bg-gray-800/50 p-7 rounded-2xl border border-gray-700 shadow-sm">
              <h3 className="text-2xl font-semibold text-blue-300 mb-5">
                Step 3: Choose your activity level from sedentary to extra
                active
              </h3>
              <p className="text-gray-200 leading-relaxed text-base mb-6">
                Select how active you are on an average week. The calculator
                instantly applies the correct multiplier to convert your BMR
                into TDEE. Options range from Sedentary (desk job, little
                exercise) all the way to Extra Active (intense training or
                physically demanding job 6–7 days per week).
              </p>
              <ul className="list-disc list-inside text-gray-200 space-y-3 text-base">
                ...
                <li>
                  Extra active – athlete-level training or labour-intensive job
                </li>
              </ul>
              <p className="text-gray-300 italic mt-6 text-base">
                Pro tip: Be honest with your selection. Overestimating activity
                is one of the most common reasons people stall on their
                weight-loss journey.
              </p>
            </div>
          </div>
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 leading-relaxed mb-6 text-base">
            BMR is the number of calories your body burns every day just to stay
            alive — breathing, circulating blood, regulating temperature, and
            maintaining organs — while you are completely at rest. For most
            people, BMR accounts for 60–75% of total daily calorie burn. Knowing
            your exact BMR is the first step toward science-based nutrition
            instead of guessing.
          </p>
          ...
          <p className="text-gray-200 leading-relaxed mb-6 text-base">
            TDEE = BMR × Activity Multiplier. This simple multiplication turns
            your resting calorie burn into a realistic daily target that
            includes walking, work, workouts, and even digestion. The result
            tells you exactly how many calories you need to maintain, lose, or
            gain weight.
          </p>
            ...
            <table className="min-w-full text-sm text-white border border-gray-700 rounded-xl overflow-hidden">
              <thead>
                <tr className="bg-blue-900/70">
                  ...
                  <th className="p-4 text-left font-semibold">
                    Example Daily Burn (for 70 kg male, age 30)
                  </th>
                </tr>
              </thead>
          ...
          <p className="text-gray-200 text-base leading-relaxed mb-4">
            This tool uses the revised Harris-Benedict equation, one of the most
            validated formulas worldwide. It was developed in 1919 and later
          ...
          <p className="text-gray-300 italic text-base mt-4">
            Example: 30-year-old male, 70 kg, 175 cm → BMR = 1,950 kcal. With
            moderate activity (1.55×) his TDEE becomes 3,022 kcal/day.
          </p>
        </section>
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 leading-relaxed text-base mb-4">
            Safe and sustainable fat loss happens at a 500–750 kcal daily
            deficit below your TDEE. This typically equals 0.5–0.75 kg (1–1.5
            lb) of fat loss per week. Never drop below 1,200 kcal (women) or
            1,500 kcal (men) without medical supervision.
          </p>
          <p className="text-gray-200 text-base font-mono bg-gray-900 p-4 rounded-xl">
            Example: TDEE = 3,000 kcal → Weight-loss target = 2,300–2,500
            kcal/day
          </p>
          ...
          <p className="text-gray-200 leading-relaxed text-base">
            Simply eat at your exact TDEE. This is the sweet spot for athletes
            who want to stay lean while performing at peak levels or for anyone
            who has reached their ideal weight and wants to keep it.
          </p>
          ...
          <p className="text-gray-200 leading-relaxed text-base mb-4">
            A modest surplus of 250–500 kcal above TDEE, paired with progressive
            resistance training and high protein (1.6–2.2 g per kg body weight),
            supports clean muscle growth with minimal fat gain.
          </p>
          <p className="text-gray-200 text-base font-mono bg-gray-900 p-4 rounded-xl">
            Example: TDEE = 3,000 kcal → Muscle-gain target = 3,250–3,500
            kcal/day
          </p>
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 leading-relaxed text-base">
            With your consent, the calculator stores your last age, weight,
            height, gender, and activity level using secure, functional cookies.
            Next time you visit your numbers load instantly so you can track
            progress week after week without re-entering data. You can clear or
            manage cookies anytime from the settings panel.
          </p>
          ...
          <p className="text-gray-200 leading-relaxed text-base">
            As soon as you click a new activity level, the entire result updates
            instantly. No page refresh, no waiting — perfect for experimenting
            with “what if I train 5 days instead of 3?”
          </p>
          ...
          <p className="text-gray-200 text-base mb-6">
            Built with a clean, touch-first design that works beautifully on
            every smartphone, tablet, or desktop. Large buttons, readable
            numbers, and dark-mode friendly colours make daily logging
            effortless whether you’re at the gym or meal-prepping at home.
          </p>
          ...
          <p className="text-gray-200 text-base">
            Office job, driving, minimal walking. Most common for students and
            remote workers in Pakistan.
          </p>
          ...
          <p className="text-gray-200 text-base">
            Gym 3–5 days a week + daily steps. Ideal for beginners building
            sustainable habits.
          </p>
          ...
          <p className="text-gray-200 text-base">
            Intense training 6–7 days, sports, or physically demanding jobs.
            Perfect for serious athletes and bodybuilders.
          </p>
        </section>
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 text-base mb-6">
            Let’s see the calculator in action with real examples relevant to
            people in Pakistan and worldwide.
          </p>
          <div className="overflow-x-auto mt-8 mb-12">
            <table className="min-w-full text-sm text-white border border-gray-700 rounded-xl overflow-hidden">
              <thead>
              ...
              <tbody className="bg-gray-800/50 divide-y divide-gray-700">
                <tr>
                  <td className="p-4">
                    Sahiwal student, male, 22 y, 68 kg, 172 cm
                  </td>
                ...
                <tr>
                  <td className="p-4">
                    Karachi working mom, female, 35 y, 62 kg, 158 cm
                  </td>
                ...
                <tr>
                  <td className="p-4">
                    Lahore gym-goer, male, 28 y, 80 kg, 180 cm
                  </td>
          ...
          <p className="text-gray-300 italic text-center mt-8 text-lg">
            Pair your calorie tracking with our other free tools for complete
            nutrition mastery.
          </p>
        ...
        <section className="mt-20">
          ...
          <p className="text-gray-200 text-base">
            Studies show it predicts BMR within ±5–10% for most healthy adults.
            Combine it with consistent tracking of weight and measurements for
            even better real-world accuracy.
          </p>
          ...
          <p className="text-gray-200 text-base">
            No — flexibility is key. Many people use a weekly average so they
            can enjoy family dinners or weekend treats while still hitting
            long-term goals.
          </p>
          ...
          <p className="text-gray-200 text-base">
            The base formula works, but add the extra calories recommended by
            your doctor (usually +300–500 kcal). Always consult a healthcare
            professional for special conditions.
          </p>
        </section>

        <p className="text-gray-300 italic text-center mt-20 text-lg font-medium leading-relaxed">
          Master your calories, master your results. Our free Calorie and TDEE
          Calculator is fast, accurate, completely private, and always ready —
          whether you’re in anyplace or anywhere else in the world. Bookmark it
          today and take the guesswork out of your fitness journey forever!
        </p>
      </article>
