...
// FIXES APPLIED:
// 1. Removed backdrop-blur-md from nav — backdrop-filter is one of the most expensive CSS
//    properties on mobile. It forces a new compositing layer for the entire page behind it.
//    Replaced with solid bg-card which looks nearly identical.
// 2. Removed shadow-sm from nav — another composite layer trigger on every scroll tick
// 3. Removed bg-card/80 opacity — replaced with solid bg-card (opacity layers = composite cost)
// 4. SearchBar dynamic import kept as-is — already correct
// 5. animate-in slide-in-from-top on mobile menu kept — it's a one-time cheap animation
